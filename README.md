...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            ApiResponse apiResponse = await api.SearchEventsAsync(limit: 2);
            EventSearch model = apiResponse.Ok();
            // You can also access the raw content and headers:
            // string rawContent = apiResponse.RawContent;
            // HttpResponseHeaders headers = apiResponse.Headers;
        }
