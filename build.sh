...
${nuget_cmd} install src/FingerprintPro.ServerSdk/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/FingerprintPro.ServerSdk.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/FingerprintPro.ServerSdk.dll \
-recurse:'src/FingerprintPro.ServerSdk/*.cs' \
-doc:bin/FingerprintPro.ServerSdk.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/FingerprintPro.ServerSdk.dll was created successfully"
fi
