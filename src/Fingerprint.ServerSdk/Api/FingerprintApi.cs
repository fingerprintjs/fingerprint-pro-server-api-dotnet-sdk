...
namespace Fingerprint.ServerSdk.Api
{
    ...
    public interface IFingerprintApi
    {
        ...
        /// </remarks>
        /// <exception cref="Fingerprint.ServerSdk.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <param name="developerTools">Filter events by Developer Tools detection result. > Note: When using this parameter, only events with the `products.developerTools.data.result` property set to `true` or `false` are returned. Events without a `products.developerTools` Smart Signal result are left out of the response.  (optional)</param>
        /// <param name="locationSpoofing">Filter events by Location Spoofing detection result. > Note: When using this parameter, only events with the `products.locationSpoofing.data.result` property set to `true` or `false` are returned. Events without a `products.locationSpoofing` Smart Signal result are left out of the response.  (optional)</param>
        /// <param name="mitmAttack">Filter events by MITM (Man-in-the-Middle) Attack detection result. > Note: When using this parameter, only events with the `products.mitmAttack.data.result` property set to `true` or `false` are returned. Events without a `products.mitmAttack` Smart Signal result are left out of the response.  (optional)</param>
        /// <param name="proxy">Filter events by Proxy detection result. > Note: When using this parameter, only events with the `products.proxy.data.result` property set to `true` or `false` are returned. Events without a `products.proxy` Smart Signal result are left out of the response.  (optional)</param>
        /// <param name="sdkVersion">Filter events by a specific SDK version associated with the identification event. Example: `3.11.14`  (optional)</param>
        /// <param name="sdkPlatform">Filter events by the SDK Platform associated with the identification event. `js` - JavaScript agent (Web). `ios` - Apple iOS based devices. `android` - Android based devices.  (optional)</param>
        /// <param name="environment">Filter for events by providing one or more environment IDs.  (optional)</param>
        /// <param name="proximityId">Filter events by the most precise Proximity ID provided by default. > Note: When using this parameter, only events with the `products.proximity.id` property matching the provided ID are returned. Events without a `products.proximity` result are left out of the response.  (optional)</param>
        /// <param name="proximityPrecisionRadius">Filter events by Proximity Radius. > Note: When using this parameter, only events with the `products.proximity.precisionRadius` property set to a valid value are returned. Events without a `products.proximity` result are left out of the response.  (optional)</param>
