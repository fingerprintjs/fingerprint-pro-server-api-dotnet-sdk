...
namespace Fingerprint.ServerSdk.Api
{
    ...
    {
        public const string Version = "1.0.0-test.2";

        private readonly ApiClient _apiClient;

        private Fingerprint.ServerSdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        /// <returns></returns>
        public FingerprintApi(Fingerprint.ServerSdk.Client.Configuration configuration)
        {
            Configuration = configuration;
            _apiClient = new ApiClient(configuration);

            ExceptionFactory = Fingerprint.ServerSdk.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public Fingerprint.ServerSdk.Client.Configuration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Fingerprint.ServerSdk.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse<EventResponse> GetEventWithHttpInfo(string requestId)
        {
            ...
            localVarQueryParams.Add(new KeyValuePair<string, string>("ii", "fingerprint-pro-server-api-dotnet-sdk/1.0.0-test.2"));
