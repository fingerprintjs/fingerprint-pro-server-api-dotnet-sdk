...
namespace Fingerprint.ServerSdk.Extensions
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddFingerprint(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new HostConfiguration(services);
            options(config);
            AddFingerprint(services, config);
        }

        internal static void AddFingerprint(IServiceCollection services, HostConfiguration host)
        {
