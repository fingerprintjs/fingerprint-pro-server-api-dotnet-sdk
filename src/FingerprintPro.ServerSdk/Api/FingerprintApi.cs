...
namespace FingerprintPro.ServerSdk.Api
{
    ...
    public interface IFingerprintApi
    {
        ...
        /// </remarks>
        /// <exception cref="FingerprintPro.ServerSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="visitorId">Unique [visitor identifier](https://dev.fingerprint.com/reference/get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals.</param>
