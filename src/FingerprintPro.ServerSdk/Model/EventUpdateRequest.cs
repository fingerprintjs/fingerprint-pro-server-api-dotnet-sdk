...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public class EventUpdateRequest : IEquatable<EventUpdateRequest>
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="EventUpdateRequest" /> class.
        /// </summary>
        /// <param name="linkedId">LinkedID value to assign to the existing event.</param>
        /// <param name="tag">Full `tag` value to be set to the existing event. Replaces any existing `tag` payload completely..</param>
        /// <param name="suspect">Suspect flag indicating observed suspicious or fraudulent event.</param>
        public EventUpdateRequest(string linkedId = default(string), Object tag = default(Object), bool? suspect = default(bool?))
        {
        ...
        /// </summary>
        /// <value>Full `tag` value to be set to the existing event. Replaces any existing `tag` payload completely.</value>
        ...
        /// <summary>
        /// Returns true if EventUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EventUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventUpdateRequest input)
        {
            if (input == null)
                return false;
