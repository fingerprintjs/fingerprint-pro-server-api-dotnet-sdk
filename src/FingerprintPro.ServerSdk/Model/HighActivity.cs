...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public class HighActivity : IEquatable<HighActivity>
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="HighActivity" /> class.
        /// </summary>
        ...
        public HighActivity(bool? result = default(bool?), long? dailyRequests = default(long?))
        {
            // to ensure "result" is required (not null)
            // swagger debug: HighActivity Result

            if (result == null)
            {
                throw new InvalidDataException("result is a required property for HighActivity and cannot be null");
            }
            else
            {
                this.Result = result;
        ...
        /// <summary>
        /// Returns true if HighActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of HighActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HighActivity? input)
        {
            if (input == null)
                return false;
