...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    public partial class IdentificationError : IEquatable<IdentificationError>
    {
        ...
        /// </summary>
        /// <param name="code">Error code:  * `429 Too Many Requests` - the limit on secret API key requests per second has been exceeded  * `Failed` - internal server error  (required).</param>
        ...
        public IdentificationError(CodeEnum code = default(CodeEnum), string message = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for IdentificationError and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for IdentificationError and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Returns true if IdentificationError instances are equal
        /// </summary>
