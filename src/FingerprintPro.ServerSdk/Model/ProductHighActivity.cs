...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ProductHighActivity : IEquatable<ProductHighActivity>
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="ProductHighActivity" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">error.</param>
        public ProductHighActivity(HighActivity data = default(HighActivity), Error error = default(Error))
        {
            this.Data = data;
            this.Error = error;
        }
        ...
        public HighActivity Data { get; set; }
        ...
        /// <summary>
        /// Returns true if ProductHighActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductHighActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductHighActivity? input)
        {
            if (input == null)
                return false;
