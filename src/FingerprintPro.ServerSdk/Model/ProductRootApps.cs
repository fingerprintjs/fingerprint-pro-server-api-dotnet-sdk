...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ProductRootApps : IEquatable<ProductRootApps>
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="ProductRootApps" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">error.</param>
        public ProductRootApps(RootApps data = default(RootApps), Error error = default(Error))
        {
            this.Data = data;
            this.Error = error;
        }
        ...
        /// <summary>
        /// Returns true if ProductRootApps instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductRootApps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductRootApps? input)
        {
            if (input == null)
                return false;
