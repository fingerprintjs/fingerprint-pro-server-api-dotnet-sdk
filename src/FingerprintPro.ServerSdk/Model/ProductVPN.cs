...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ProductVPN : IEquatable<ProductVPN>
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVPN" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">error.</param>
        public ProductVPN(VPN data = default(VPN), Error error = default(Error))
        {
            this.Data = data;
            this.Error = error;
        }
        ...
        /// <summary>
        /// Returns true if ProductVPN instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVPN to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVPN? input)
        {
            if (input == null)
                return false;
