...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ProductVelocity : IEquatable<ProductVelocity>
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVelocity" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">error.</param>
        public ProductVelocity(Velocity data = default(Velocity), Error error = default(Error))
        {
            this.Data = data;
            this.Error = error;
        }
        ...
        /// <summary>
        /// Returns true if ProductVelocity instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVelocity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVelocity? input)
        {
            if (input == null)
                return false;
