...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SignalResponseEmulatorData : IEquatable<SignalResponseEmulatorData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignalResponseEmulatorData" /> class.
        /// </summary>
        ...
        public SignalResponseEmulatorData(bool? result = default(bool?))
        {
            this.Result = result;
        }
        ...
        /// <summary>
        /// Returns true if SignalResponseEmulatorData instances are equal
        /// </summary>
        /// <param name="input">Instance of SignalResponseEmulatorData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignalResponseEmulatorData input)
        {
            if (input == null)
                return false;
