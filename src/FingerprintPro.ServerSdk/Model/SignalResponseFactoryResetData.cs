...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SignalResponseFactoryResetData : IEquatable<SignalResponseFactoryResetData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignalResponseFactoryResetData" /> class.
        /// </summary>
        ...
        public SignalResponseFactoryResetData(DateTime? time = default(DateTime?), long? timestamp = default(long?))
        {
            this.Time = time;
        ...
        /// <summary>
        /// Returns true if SignalResponseFactoryResetData instances are equal
        /// </summary>
        /// <param name="input">Instance of SignalResponseFactoryResetData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignalResponseFactoryResetData input)
        {
            if (input == null)
                return false;
