...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SignalResponseVpn : IEquatable<SignalResponseVpn>
    {
        /// <summary>
        ...
        public SignalResponseVpn(VpnResult data = default(VpnResult), ProductError error = default(ProductError))
        {
            this.Data = data;
            this.Error = error;
        }
        ...
        /// <summary>
        /// Returns true if SignalResponseVpn instances are equal
        /// </summary>
