...
namespace FingerprintPro.ServerSdk.Model
{
    ...
    public class WebhookMitMAttack : IEquatable<WebhookMitMAttack>
    {
        ...
        /// <summary>
        /// Returns true if WebhookMitMAttack instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookMitMAttack to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookMitMAttack? input)
        {
            if (input == null)
                return false;
