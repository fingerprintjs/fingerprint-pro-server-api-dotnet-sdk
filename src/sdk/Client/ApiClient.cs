...
{
    /// <summary>
    /// API client is mainly responsible for making the HTTP call to the API backend. WOOO TEST
    /// </summary>
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = sdk.Client.Configuration.Default;
        ...
        {
            Configuration = config ?? sdk.Client.Configuration.Default;
