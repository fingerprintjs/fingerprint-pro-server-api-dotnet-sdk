...
/// </summary>
[DataContract]
public class ProductsResponse : IEquatable<ProductsResponse>, IValidatableObject
{
    /// <summary>
    ...
    public ProductsResponse(ProductsResponseIdentification identification = default,
        ProductsResponseBotd botd = default)
    {
    ...
    {
        return Equals(input as ProductsResponse);
    }
    ...
    public override int GetHashCode()
    {
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (Botd != null)
                hashCode = hashCode * 59 + Botd.GetHashCode();
            return hashCode;
        }
    }
}