...
/// </summary>
[DataContract]
public class ProductsResponseIdentification : IEquatable<ProductsResponseIdentification>, IValidatableObject
{
    /// <summary>
    ...
    public ProductsResponseIdentification(
        ProductsResponseIdentificationData data = default)
    {
        Data = data;
    }
    ...
    {
        return Equals(input as ProductsResponseIdentification);
    }
