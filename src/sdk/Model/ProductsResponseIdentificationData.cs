    ...
    IValidatableObject
{
    ...
    public ProductsResponseIdentificationData(string requestId = default,
        ...
        string visitorId = default)
    {
        ...
        if (requestId == null)
            throw new InvalidDataException(
                "requestId is a required property for ProductsResponseIdentificationData and cannot be null");
        RequestId = requestId;
        // to ensure "browserDetails" is required (not null)

        if (browserDetails == null)
            throw new InvalidDataException(
                "browserDetails is a required property for ProductsResponseIdentificationData and cannot be null");
        BrowserDetails = browserDetails;
        // to ensure "incognito" is required (not null)

        if (incognito == null)
            throw new InvalidDataException(
                "incognito is a required property for ProductsResponseIdentificationData and cannot be null");
        Incognito = incognito;
        // to ensure "ip" is required (not null)

        if (ip == null)
            throw new InvalidDataException(
                "ip is a required property for ProductsResponseIdentificationData and cannot be null");
        Ip = ip;
        // to ensure "ipLocation" is required (not null)

        if (ipLocation == null)
            throw new InvalidDataException(
                "ipLocation is a required property for ProductsResponseIdentificationData and cannot be null");
        IpLocation = ipLocation;
        // to ensure "timestamp" is required (not null)

        if (timestamp == null)
            throw new InvalidDataException(
                "timestamp is a required property for ProductsResponseIdentificationData and cannot be null");
        Timestamp = timestamp;
        // to ensure "time" is required (not null)

        if (time == null)
            throw new InvalidDataException(
                "time is a required property for ProductsResponseIdentificationData and cannot be null");
        Time = time;
        // to ensure "url" is required (not null)

        if (url == null)
            throw new InvalidDataException(
                "url is a required property for ProductsResponseIdentificationData and cannot be null");
        Url = url;
        // to ensure "confidence" is required (not null)

        if (confidence == null)
            throw new InvalidDataException(
                "confidence is a required property for ProductsResponseIdentificationData and cannot be null");
        Confidence = confidence;
        // to ensure "visitorFound" is required (not null)

        if (visitorFound == null)
            throw new InvalidDataException(
                "visitorFound is a required property for ProductsResponseIdentificationData and cannot be null");
        VisitorFound = visitorFound;
        // to ensure "firstSeenAt" is required (not null)

        if (firstSeenAt == null)
            throw new InvalidDataException(
                "firstSeenAt is a required property for ProductsResponseIdentificationData and cannot be null");
        FirstSeenAt = firstSeenAt;
        // to ensure "lastSeenAt" is required (not null)

        if (lastSeenAt == null)
            throw new InvalidDataException(
                "lastSeenAt is a required property for ProductsResponseIdentificationData and cannot be null");
        LastSeenAt = lastSeenAt;
        // to ensure "visitorId" is required (not null)

        if (visitorId == null)
            throw new InvalidDataException(
                "visitorId is a required property for ProductsResponseIdentificationData and cannot be null");
        VisitorId = visitorId;
    ...
    {
        return Equals(input as ProductsResponseIdentificationData);
    }
