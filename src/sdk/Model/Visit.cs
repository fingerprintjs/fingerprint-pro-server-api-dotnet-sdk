...
/// </summary>
[DataContract]
public class Visit : IEquatable<Visit>, IValidatableObject
{
    /// <summary>
    ...
    public Visit(string requestId = default, BrowserDetails browserDetails = default,
        ...
        StSeenAt firstSeenAt = default, StSeenAt lastSeenAt = default)
    {
        ...
        if (ipLocation == null)
            throw new InvalidDataException("ipLocation is a required property for Visit and cannot be null");
