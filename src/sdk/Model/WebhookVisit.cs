...
/// </summary>
[DataContract]
public class WebhookVisit : IEquatable<WebhookVisit>, IValidatableObject
{
    /// <summary>
    ...
    public WebhookVisit(string visitorId = default, string clientReferrer = default,
        string requestId = default, BrowserDetails browserDetails = default,
        bool? incognito = default, string ip = default, IPLocation ipLocation = default,
        long? timestamp = default, DateTime? time = default, string url = default,
        ...
        StSeenAt firstSeenAt = default, StSeenAt lastSeenAt = default)
    {
        ...
        if (browserDetails == null)
            throw new InvalidDataException(
                "browserDetails is a required property for WebhookVisit and cannot be null");
        ...
        if (visitorFound == null)
            throw new InvalidDataException(
                "visitorFound is a required property for WebhookVisit and cannot be null");
        VisitorFound = visitorFound;
        // to ensure "firstSeenAt" is required (not null)

        if (firstSeenAt == null)
            throw new InvalidDataException(
                "firstSeenAt is a required property for WebhookVisit and cannot be null");
    ...
    public bool Equals(WebhookVisit input)
    {
        ...
        return
            ...
            (
                ClientReferrer == input.ClientReferrer ||
                (ClientReferrer != null &&
                 ClientReferrer.Equals(input.ClientReferrer))
            ) &&
            (
    ...
    {
        return Equals(input as WebhookVisit);
    }
    ...
    public override int GetHashCode()
    {
        unchecked // Overflow is fine, just wrap
        {
            ...
            if (ClientReferrer != null)
                hashCode = hashCode * 59 + ClientReferrer.GetHashCode();
            if (RequestId != null)
